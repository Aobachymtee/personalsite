...
const base = `<span style="color: #b8d5ef">aoba.space</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
		...
		case "Enter":
			...
			if (d) {
				...
				switch (f) {
					...
					default:
						d = false;
						writeLine(`OwO: command not found: ${f}`);
						break
				}
			}
			switchToNewLine(d);
...
function inputLine(k) {
	terminal.innerHTML += `\n<div class=\"new-line\"><span style=\"color: #b8d5ef\">aoba.space</span>:<span style=\"color: dodgerblue\">~</span>$ ${k?k:""}</div>`
}
...
function info() {
	terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>contact</span>@<span>aoba.space</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>OS</span>: Yumesute</div>\n" + "  <div><span>Ages</span>: 18</div>\n" + "  <div><span>Twitter</span>: <a href=\"https://twitter.com/Aobachymtee\" target='_blank'>@aobachymtee</a></div>\n" + "  <div><span>Discord</span>: <a href=\"https://discord.com/users/391760551044186114\" target='_blank'>_aoba</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://www.youtube.com/channel/UCvJNF34LJh3NIGT848J9Q8w\" target='_blank'>Aoba Hoc Dich</a></div>\n" + "  <div><span>Facebook</span>: <a href=\"https://www.facebook.com/aobachymtee\" target='_blank'>Thanh Hieu</a></div>\n" + "  <div><span>Project Sekai? </span>: [VN]Aoba</a></div>\n" + "  <div>---------------------</div>\n" + "  <div>Type: <span>help</span> for more thing ^^</div>\n" + ' <div style="padding-bottom:10px; clear: both;">'
}

function project() {
	terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>contact</span>@<span>aoba.space</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>Fansub (Project Sekai)</span>: <a href=\"https://www.facebook.com/MimoriHopeClover\" target='_blank'>@MinoriHopeClover</a></div>\n" + "  <div><span>Fansub (Yamesute)</span>: <a href=\"https://www.facebook.com/wdsvietnam\" target='_blank'>World Dai Star Vietnam</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://www.youtube.com/channel/UCvJNF34LJh3NIGT848J9Q8w\" target='_blank'>Aoba Hoc Dich</a></div>\n" + ' <div style="padding-bottom:10px; clear: both;">'
}

function help() {
	terminal.innerHTML += "  <div><span>contact</span>@<span>aoba.space</span></div>\n" + "  <div>---------------------</div>\n" + " <div><span>Command</span>: help, info, project</div>\n" + ' <div style="padding-bottom:10px; clear: both;">'	
}